package com.foxconn.eerf.database.datasource;
...
import com.foxconn.eerf.base.id.IdGenerate;
import com.foxconn.eerf.base.id.SnowflakeIdGenerate;
import com.foxconn.eerf.database.mybatis.typehandler.FullLikeTypeHandler;
import com.foxconn.eerf.database.mybatis.typehandler.LeftLikeTypeHandler;
import com.foxconn.eerf.database.mybatis.typehandler.RightLikeTypeHandler;
import com.foxconn.eerf.database.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "eerf.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
