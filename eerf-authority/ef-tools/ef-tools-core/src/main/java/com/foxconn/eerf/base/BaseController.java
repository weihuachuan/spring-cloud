...
import com.foxconn.eerf.context.BaseContextHandler;
import com.foxconn.eerf.exception.BizException;
import com.foxconn.eerf.exception.code.BaseExceptionCode;
import com.foxconn.eerf.utils.AntiSqlFilter;
...
public abstract class BaseController {
    ...
    private LocalDateTime getLocalDateTime(String endCreateTime) {
        ...
        return LocalDateTime.parse(safeValue, DateTimeFormatter.ofPattern(DateUtils.DEFAULT_DATE_TIME_FORMAT));
    }
}
