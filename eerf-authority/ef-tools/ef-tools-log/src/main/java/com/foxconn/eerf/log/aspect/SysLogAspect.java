package com.foxconn.eerf.log.aspect;
...
import com.foxconn.eerf.log.event.SysLogEvent;
import com.foxconn.eerf.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.foxconn.eerf.log.annotation.SysLog)")
